...
Objective 3: Optimize the workflow application to achieve a task-creation time under at most 5 seconds for a new user supported by contextual tooltips to explain concepts to junior developers.
Objective 4: Attracting 20 users (student/trainee) to try the platform in the launch week.
